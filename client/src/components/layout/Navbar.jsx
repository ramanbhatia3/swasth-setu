...
import { Home, Search, Brain, MessageSquare, User, Menu, X, Activity, LogOut, FileText } from 'lucide-react';
            ...
            <div className="px-4 pt-2 pb-4 space-y-1 shadow-inner">
              ...
              {user ? (
                <div className="mt-4 pt-4 border-t border-slate-100">
                  ...
                  <button onClick={() => { logout(); closeMenu(); }} className="flex w-full items-center gap-3 px-3 py-3 mt-2 rounded-md text-base font-medium bg-red-50 text-red-600">
                    <LogOut size={20} /> Logout
                  </button>
                </div>
              ) : (
                <div className="mt-4 pt-4 border-t border-slate-100">
                  <NavLink to="/login" onClick={closeMenu} className="flex items-center justify-center gap-3 px-3 py-3 rounded-md text-base font-medium bg-blue-600 text-white shadow-sm">
